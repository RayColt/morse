...
Windows C++ console app with sound:(C++ console app with sound: In principle you only need morse.cpp and morse-wav.cpp to create Codeblocks project or download <a href=https://github.com/RayColt/morse-cmd-win>this Visual Studio project</a>.)
